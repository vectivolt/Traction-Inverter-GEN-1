...
> and the 35 V double event (IR-16 ≥ 0.29 Ω / IR-33). RELEASE GATES since round 18 (F191–F194): (a) QP-RX-05 — the
...
> and the tripped PTC's trickle leaves 1.5–4 W in the TVS (dfm.md: TVS copper island with the PTC thermally coupled
> on it; IR-42; VR-17). RSX is an anti-surge 0.5 W part (the powered negative fault). Since round 19 (F199/F200) the
> ≥ 8 A clearing measurement (trip ≤ 20 ms, ∫v·i ≤ 5.3 J at 0 / 0.09 / 0.5 Ω, 16 / 24 / 26 V) is a release criterion too —
