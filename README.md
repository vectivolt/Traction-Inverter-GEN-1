...
> SMDJ8.5A-HRA's 5.3 J rectangular-equivalent, PTC current ≤ 40 A at the IR-16 harness minimum), the PTC hold (IR-13)
...
> on it; IR-42; VR-17). RSX is an anti-surge 0.5 W part (the powered negative fault). Measured for the record:
