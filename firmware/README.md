...
`TI_FW_ID` was 0x0A0F0012 for this round-18 image (0x0A0F0013 since round 19): each image needs a new EOL/HIL validation record before it arms (checklist T-05); the
