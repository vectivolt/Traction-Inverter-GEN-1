...
## power — 309 components, 84 BOM lines, ≈ ₹63,882 @1k
...
| 6 | VGT12EEM-200S1A4 | gate-drive flyback transformer EE, AEC-Q200, 2.6 kVrms reinf | 2,100 | Wurth 750318131 class / CN custom-wound  |
...
| 4 | WW-560R-10W-AX | 560 R 10 W axial ceramic wirewound, >=100 J single pulse | 112 | TE SQP500JB / Vishay AC10 / RX27-1 |

## control-card — 217 components, 79 BOM lines, ≈ ₹5,801 @1k
...
| Vehicle connector + prot | 785 | 1.1% | 94.1% | 6 |
...
| Category | ₹ | share |
|---|---|---|
| power semiconductors | 55,170 | 79.2% |
| drive + control ICs | 5,346 | 7.7% |
| capacitors | 4,847 | 7.0% |
| isolation | 2,426 | 3.5% |
...
| magnetics | 37 | 0.1% |
| **TOTAL (electronics, ex-PCB/mech/busbar/coldplate)** | **69,683** | 100% |
