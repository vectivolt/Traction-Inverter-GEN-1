# Traction Inverter — 8XX · SiC (HCS600FH120D3C1), 500–850 V bus — BOM (rev A.16, generated 2026-09-25)
...
## power — 324 components, 97 BOM lines, ≈ ₹60,381 @1k
...
|---|---|---|---|---|
| SiC power modules | 54,000 | 74.0% | 74.0% | 3 |
| DC-link film caps | 4,800 | 6.6% | 80.6% | 16 |
| Hall sensors + AFE | 2,327 | 3.2% | 83.8% | 38 |
| Gate-power flybacks | 2,252 | 3.1% | 86.8% | 77 |
| MCU + clock + debug | 1,496 | 2.0% | 88.9% | 22 |
| VDC iso sensing + bias | 1,296 | 1.8% | 90.7% | 30 |
| Discharge (active+passive) | 1,146 | 1.6% | 92.2% | 33 |
| Vehicle connector + prot | 788 | 1.1% | 93.3% | 6 |
| FS26 SBC + LV input + wake | 691 | 0.9% | 94.3% | 40 |
| Gate drivers + networks | 659 | 0.9% | 95.2% | 129 |
| ASC buffer | 650 | 0.9% | 96.1% | 18 |
| misc | 602 | 0.8% | 96.9% | 56 |
| Module snubbers | 540 | 0.7% | 97.6% | 3 |
| Harness + pulldowns | 495 | 0.7% | 98.3% | 17 |
| HV entry/Y-caps/HVIL/studs | 302 | 0.4% | 98.7% | 14 |
| LV power (prot+LDO+boost) | 278 | 0.4% | 99.1% | 28 |
| Resolver AFE | 276 | 0.4% | 99.5% | 54 |
| CAN-FD x2 | 132 | 0.2% | 99.7% | 14 |
| Temps (module/board/motor) | 97 | 0.1% | 99.8% | 24 |
| Safety chain (EN/ASC/ILK) | 89 | 0.1% | 99.9% | 43 |
...
| drive + control ICs | 7,284 | 10.0% |
| capacitors | 5,025 | 6.9% |
| magnetics | 2,195 | 3.0% |
...
| resistors | 94 | 0.1% |
| **TOTAL (electronics, ex-PCB/mech/busbar/coldplate)** | **72,981** | 100% |
