# Traction Inverter — Full unit cost @1,000 units (rev A.16)

Complete ex-works build cost per inverter at a 1,000-unit run (India assembly, India+China
supply chain), on top of the generated electronics BOM (`docs/bom.md`, **₹72,981 @1k** across
...
|---|---|---|---|---|---|
| 1 | Electronics BOM (power + cap bank + discharge + card) | 66,000 | 72,981 | 96,000 | `bom.md`; low/high = module + film-cap quote swing (§3) |
...
**₹47,481** and the ex-works baseline to **≈ ₹91k/unit (≈ ₹415/kW at 220 kW)** — at ≈0.45 pt
