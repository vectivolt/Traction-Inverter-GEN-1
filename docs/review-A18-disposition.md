...
|---|---|---|---|---|
| A17-R01 (md) | MODERATE — IR-16 allows ≥ 0.05 Ω at ≤ 26 V but the current check is hard-coded at 24 V; 26 V / 0.05 Ω gives 41.58 A (40.6 A even at the 25 °C V_BR,min) against the 40 A I_max; 35 V / 0.29 Ω gives 40.07 A (a downward rounding); avalanche-only minima 0.066 / 0.291 Ω; parameterise by voltage, do not round safety minima down, align IR-16 | **Confirmed** | `design-verify.mjs` `const i24 = (rExt, vb, rd) => (24 − vb)/…` (round 18, mine); the shared module reproduces 41.58 A at 26 V / 0.05 Ω | PTC row evaluated at 16 / 24 / 26 V (and 35 V) with `EX.rExtMin(v)` at 38 A (the verifier's 5 % margin), rounded UP: IR-16 → **0.09 / 0.33 / 0.25 Ω at the 8.5 V class, superseded within the round by 0.08 Ω at ≤ 24 V, 0.14 Ω at 26 V, 0.37 Ω at 35 V, 0.26 Ω negative after the class change (F203; round 20 aligned this cell — A18-N01)** (bare 40 A thresholds 0.017 / 0.066 / 0.291 / 0.22 Ω stated beside them); QP-RX-04 step 2 runs 16 / 24 / 26 V. **F199** |
