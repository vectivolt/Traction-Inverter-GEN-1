...
export const DB = [
  ...
  { m: /^RFS[134]$/, mpn: "R0603-1k", mfr: "any", desc: "ASC-latch strap/clear series 1 k (F40; round 7: asserted level <= 0.82 V with FS1B at its 0.4 V V_OL; RFS4 feeds FAULT_OUT — VCU load >= 10 k to <= 5 V)", fp: "R0603", price1k: 0.3, alt: "any" },
