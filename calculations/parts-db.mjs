...
export const DB = [
  ...
  { m: /^RASCL$/, mpn: "R0603-270R", mfr: "any", desc: "ASC opto LED series 270 R: >= 10 mA worst case vs the TLP152 I_FLH 7.5 mA max (round 7 — 470 R gave 5.4-7 mA)", fp: "R0603", price1k: 0.3, alt: "any" },
  ...
  { m: /^R(DRB|ARB)$/, mpn: "R0603-10k", mfr: "any", desc: "DRV_EN / ASC_CMD read-back to MCU inputs (boot self-test of the FS0B->DRV_EN chain and the ASC latch, FW-16)", fp: "R0603", price1k: 0.3, alt: "any" },
  ...
  { m: /^RENP[12]$/, mpn: "R0603-5k1", mfr: "any", desc: "FS0B/FS1B pull-ups 5.1 k (NXP value for a VDDIO pull-up): FS1B total 1.74 mA incl. ASC strap + FAULT_OUT, inside the 2 mA V_OL point (round 7 A6-R01 — 1 k let a 4 mA-limit part sit at 1.0-1.3 V, above the latch VIL and the SBC 0.7 V read-back)", fp: "R0603", price1k: 0.3, alt: "any" },
  ...
  { m: /^USCH$/, mpn: "74LVC3G17DC-Q100", mfr: "Nexperia", desc: "triple Schmitt buffer (no input-transition limit, DS Table 6): clear one-shot -> ULAT2 /CLR, soft-off delay -> UAND2, FS0B -> UAND1 (round 7 RR01/RR02/A6-R02/R03)", fp: "VSSOP8", price1k: 10, alt: "onsemi NLV37WZ17USG (US8, pin-identical)" },
  { m: /^CSCH$/, mpn: "MLCC-100nF-16V", mfr: "any", desc: "Schmitt buffer decoupling", fp: "C0603", price1k: 0.3, alt: "any" },
  ...
  { m: /^D(CLR|FO|SET)$/, mpn: "BAT46ZFILM", mfr: "ST", desc: "DCLR one-shot overshoot clamp to V5A; DFO FAULT_OUT sink-only (a wire short to ground / dead VCU input / negative spike cannot preset ASC); DSET clamps ASC_SET_N to V5A on a FAULT_OUT short to KL30 (round 7 cross-check) — same part as DBAT", fp: "SOD123", lcsc: "C283255", price1k: 1.5, alt: "CDBW46-G" },
