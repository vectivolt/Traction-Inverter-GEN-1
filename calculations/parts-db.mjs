...
export const DB = [
  ...
  { m: /^RDIS[1-4]$/, mpn: "WW-560R-10W-AX", mfr: "TT/Vitrohm", desc: "560 R 10 W axial ceramic wirewound, >=100 J single pulse (active discharge string). Not on LCSC at this value — DigiKey (TE SQP500JB / Vishay AC10) or RX27-1 via 1688", fp: "AxialWW10W", price1k: 28, alt: "TE SQP500JB / Vishay AC10 / RX27-1" },
  ...
  { m: /^U[UVW][HL]G$/, mpn: "NSI6611A-Q1", mfr: "NOVOSENSE", desc: "iso gate driver 10 A, DESAT/Miller clamp/UVLO/RDY/FLT, SOIC-16W reinforced (pin map verified: drv 1=ASC 2=DESAT 3=GND2 4=OUTH 5=VCC2 6=OUTL 7=CLAMP 8=VEE2; in 9=GND1 10=IN+ 11=IN- 12=RDY 13=FLT# 14=RST/EN 15=VCC1 16=TEST)", fp: "SOIC16W", lcsc: "C7470934", price1k: 85, alt: "NSI6602B / UCC21750-Q1 (map differs)" },
  ...
  { m: /^UF[HL]$/, mpn: "UCC28C43DR", mfr: "TI", desc: "current-mode PWM controller SOIC-8 (gate-bias flyback; UVLO 7.0/6.6 V fits 9-16 V KL30; DFM swap from NJW4140 — multi-source)", fp: "SOP8", lcsc: "C111694", price1k: 22, alt: "ST UC2843BD1013TR (C111202) / NJW4140R via DigiKey" },
  ...
  { m: /^TF[HL][123]$/, mpn: "VGT12EEM-200S1A4", mfr: "TDK (Vogt)", desc: "gate-drive flyback transformer EE, AEC-Q200, 2.6 kVrms reinforced — DigiKey-stocked, ships today (one floating secondary per phase; 3 per chain, primaries paralleled)", fp: "XfmrEE12", price1k: 350, alt: "Wurth 750318131 class / CN custom-wound to drawing at volume" },
  { m: /^RF[HL]CS[123]?$/, mpn: "R1206-0R1-3x", mfr: "any", desc: "current sense 3x 0.1 R parallel", fp: "R1206", price1k: 1, alt: "any" },
  ...
  { m: /^DF[HL]SN$/, mpn: "SMBJ85A", mfr: "any", desc: "snubber/clamp TVS", fp: "SMB", price1k: 3, alt: "P6SMB class" },
  ...
  { m: /^Z[UVW][HL]V$/, mpn: "BZT52-C4V3", mfr: "any", desc: "4.3 V zener splitting the winding -> VCC2 +15 / VEE2 -4.3 vs Kelvin (GEN3 pattern; C3V9 for -3.9)", fp: "SOD123", price1k: 0.5, alt: "BZT52-C3V9" },
  ...
  { m: /^RVDDL$/, mpn: "R0603-6k65-0.1%", mfr: "any", desc: "divider ch1 bottom (850 V -> 2.0 V)", fp: "R0603", price1k: 1, alt: "any 0.1%" },
  ...
  { m: /^RVBDL$/, mpn: "R0603-6k65-0.1%", mfr: "any", desc: "divider ch2 bottom", fp: "R0603", price1k: 1, alt: "any 0.1%" },
  ...
  { m: /^PS5B$/, mpn: "ISO5V-RFC-6K", mfr: "MORNSUN QA/URB-grade", desc: "iso 15->5 V >=1 W REINFORCED >=5 kVrms (bias for both VDC amps, DCN domain — functional-grade rejected, barrier rule)", fp: "SIP7", price1k: 95, alt: "RECOM RxxP-R certified eq" },
  { m: /^C5B[12]$/, mpn: "MLCC-1uF-25V", mfr: "any", desc: "iso 5 V rail decoupling", fp: "C0603", price1k: 0.3, alt: "any" },
  // ---- HVIL + Y-caps + entry ----
  ...
  { m: /^CY[12]$/, mpn: "Y2-4.7nF-CD", mfr: "TDK/Vishay", desc: "Y2 4.7 nF ceramic disc, DCP/DCN to chassis", fp: "DiscP10", price1k: 12, alt: "any Y2 certified" },
  ...
  { m: /^CLV[HL][12]$/, mpn: "MLCC-4.7uF-25V", mfr: "any", desc: "12 V entry filter (x4 on layout)", fp: "C1206", price1k: 1, alt: "any" },
  ...
  { m: /^CB15I$/, mpn: "MLCC-10uF-25V", mfr: "any", desc: "boost input cap", fp: "C1206", price1k: 1, alt: "any" },
  ...
  { m: /^RASCG$/, mpn: "R0603-100R", mfr: "any", desc: "ASC drive series", fp: "R0603", price1k: 0.3, alt: "any" },
  ...
  { m: /^FLVC$/, mpn: "MF-LSMF300/24X-2", mfr: "Bourns", desc: "card 12 V polyfuse (exact part on LCSC)", fp: "PTC2920", lcsc: "C719172", price1k: 8, alt: "RUILON SMD2920 class" },
  ...
  { m: /^CLVC[12]$/, mpn: "MLCC-4.7uF-25V", mfr: "any", desc: "card 12 V filter", fp: "C1206", price1k: 1, alt: "any" },
  ...
  { m: /^RENP[12]$/, mpn: "R0603-120R", mfr: "any", desc: "FS0B/FS1B pull-ups to VDD_HV_A", fp: "R0603", price1k: 0.3, alt: "any" },
  ...
  { m: /^ULAT$/, mpn: "SN74LVC1G74DCUR", mfr: "TI", desc: "D-latch: ASC_CMD latched (survives MCU reset; LCSC-stocked 6k+)", fp: "VSSOP8", lcsc: "C70285", price1k: 8, alt: "74LVC1G175" },
  ...
  { m: /^UVD[12]$/, mpn: "OPA376AQDBVRQ1", mfr: "TI", desc: "VDC differential receiver (iso-amp diff pair -> single-ended to ADC)", fp: "SOT23-5", price1k: 28, alt: "OPA320-Q1" },
  ...
  { m: /^D(SIN|COS)P$/, mpn: "PESD5V0L1BA", mfr: "Nexperia", desc: "resolver line clamps (GEN3 exact)", fp: "SOD323", price1k: 0.8, alt: "PESD5V0U1UA" },
  ...
  { m: /^DMT[12]$/, mpn: "PESD5V0U1UA", mfr: "Nexperia", desc: "motor-temp clamp (GEN3 exact)", fp: "SOD323", price1k: 0.8, alt: "any" },
