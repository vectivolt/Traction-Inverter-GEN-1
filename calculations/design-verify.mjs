...
| F200 | MED | Round 19 (A17-R02 md/html, all three rechecks): the ≥ 8 A single-fault TVS-energy PASS rested on "trip time falls at least as fast as I⁻² above 8 A" — the sheet gives one maximum (8 A / 20 ms) and a TYPICAL curve; nothing above 8 A is guaranteed | the row is a WARN with the assumption explicit (the 8 A max/typ ratio 3.8× carried up the typical curve: 0.5 J at 40 A; the full-20 ms sensitivity 4.3 / 8.9 J printed beside it); QP-RX-04 step 2 is a RELEASE CRITERION (trip ≤ 20 ms and ∫v·i ≤ 5.3 J at 0 / 0.09 / 0.5 Ω, cold / hot / post-trip); VR-16 asks Bourns for the maximum envelope above 8 A vs temperature |
