...
const SUBSYS = [
  ...
  ["Safety chain (EN/ASC/ILK)", /^(UAND|UOR|ULAT|USCH|CSCH|RSCH|REN|RFS|RGPD|RFLT|DFLT|CFLT|CCLR|DCLR|DFO|ZSET|UASCG|CASCG|RQDM|RFCB|RV5G|RRDB|RDRB|RARB|RRDYP|RLAT|RASCP|CLAT|RILK|CILK)/],
